...
const AreaChart = () => {
    ...
    const updateData = (timeline) => {
        ...
        if (chartRef.current && minDate && maxDate) {
            const newOptions = {
                ...options,
                xaxis: {
                    ...options.xaxis,
            ...
            chartRef.current.updateOptions(newOptions, false, true);
        }
    };
            ...
            <div className="col-xl-8 col-lg-7 ">
                ...
                <div id="chart">
                    ...
                    <div id="chart-timeline">
                        <ReactApexChart ref={chartRef} options={options} series={series} type="area" height={350} />
                    </div>
                </div>
            </div>
